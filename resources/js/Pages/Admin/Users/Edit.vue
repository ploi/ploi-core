                            ...
                            <SettingsSegment>
                                ...
                                <template #form>
                                    <form class="space-y-4" @submit.prevent="submit">
                                        ...
                                        <FormInput :label="__('Email')" :errors="$page.errors.email" type="email" v-model="form.email" />
                                        <FormTextarea :label="__('Notes')" :errors="$page.errors.notes" v-model="form.notes" />
