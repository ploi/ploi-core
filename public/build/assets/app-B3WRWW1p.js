...
function requireLodash_isequal() {
  ...
  (function(module, exports) {
    ...
    var Buffer2 = moduleExports ? root.Buffer : void 0, Symbol2 = root.Symbol, Uint8Array2 = root.Uint8Array, propertyIsEnumerable = objectProto.propertyIsEnumerable, splice = arrayProto2.splice, symToStringTag = Symbol2 ? Symbol2.toStringTag : void 0;
...
function applyModelFromMixins(model, mixins2) {
  if (mixins2) {
    mixins2.forEach((m2) => {
      if (m2.model) extend$1(model, m2.model);
...
function compatH(type2, propsOrChildren, children) {
  ...
  const is2ndArgArrayChildren = isArray$1(propsOrChildren);
...
function convertLegacySlots(vnode) {
  ...
  let slots;
  if (vnode.shapeFlag & 6 && isArray$1(children)) {
    slots = {};
    for (let i = 0; i < children.length; i++) {
      const child = children[i];
...
function defineLegacyVNodeProperties(vnode) {
  if (isCompatEnabled$1(
    ...
    Object.defineProperties(vnode, {
      ...
      text: { get: () => isString$1(vnode.children) ? vnode.children : null },
    ...
    if (publicGetter) {
    ...
    ) {
      {
        ...
        if (desc.get) {
          ...
          return isFunction$1(val) ? extend$1(val.bind(instance.proxy), val) : val;
        }
      }
    } else ;
  },
...
function mergeModels(a, b2) {
  if (!a || !b2) return a || b2;
  if (isArray$1(a) && isArray$1(b2)) return a.concat(b2);
...
function createWatcher(raw, ctx, publicThis, key) {
  ...
  const options = {};
  {
    ...
    if (isArray$1(newValue) && isCompatEnabled$1("WATCH_ARRAY", instance)) {
      options.deep = true;
    }
    const baseGetter = getter;
    getter = () => {
      const val = baseGetter();
      if (isArray$1(val) && checkCompatEnabled$1("WATCH_ARRAY", instance)) {
        traverse(val);
      }
      return val;
    };
...
function createCompatVue$1(createApp2, createSingletonApp) {
  ...
  function createCompatApp(options = {}, Ctor) {
    ...
    const { data } = options;
    if (data && !isFunction$1(data) && softAssertCompatEnabled("OPTIONS_DATA_FN", null)) {
      options.data = () => data;
    }
  ...
  Vue2.use = (plugin, ...options) => {
    if (plugin && isFunction$1(plugin.install)) {
  ...
  function extendCtor(extendOptions = {}) {
    ...
    for (const key in Super.options) {
      ...
      mergeBase[key] = isArray$1(superValue) ? superValue.slice() : isObject$2(superValue) ? extend$1(/* @__PURE__ */ Object.create(null), superValue) : superValue;
    }
...
function applySingletonAppMutations(app) {
  ...
  for (const key in singletonApp.config) {
    ...
    if (key === "ignoredElements" && isCompatEnabled$1("CONFIG_IGNORED_ELEMENTS", null) && !isRuntimeOnly() && isArray$1(val)) {
      app.config.compilerOptions.isCustomElement = (tag) => {
        return val.some((v2) => isString$1(v2) ? v2 === tag : v2.test(tag));
      };
    }
  }
...
function installCompatMount(app, context, render2) {
  ...
  app._createRoot = (options) => {
    ...
    const hasNoRender = !isFunction$1(component) && !component.render && !component.template;
    const emptyRender = () => {
    };
  ...
  const res = customRef((track2, trigger2) => {
    ...
    return {
      ...
      set(value) {
        ...
        i.emit(`update:${name2}`, emittedValue);
...
function convertLegacyAsyncComponent(comp) {
  ...
  } else if (isObject$2(res) && !isVNode(res) && !isArray$1(res)) {
...
function convertLegacyComponent(comp, instance) {
  ...
  if (isFunction$1(comp) && checkCompatEnabled$1("COMPONENT_ASYNC", instance, comp)) {
    ...
    }
    {
      ...
      if (globalKeyCodes) {
        for (const mod of modifiers) {
          ...
          if (codes) {
            const matches2 = isArray$1(codes) ? codes.some((code) => String(code) === keyCode) : String(codes) === keyCode;
            if (matches2) {
              return fn(event);
            }
          }
...
function findDir(node, name2, allowEmpty = false) {
  for (let i = 0; i < node.props.length; i++) {
    ...
    if (p2.type === 7 && (allowEmpty || p2.exp) && (isString$1(name2) ? p2.name === name2 : name2.test(p2.name))) {
      return p2;
    }
  }
}
...
function requireBind() {
  ...
  hasRequiredBind = 1;
  bind$1 = function bind2(fn, thisArg) {
...
function requireInterceptorManager() {
  ...
  InterceptorManager_1 = InterceptorManager2;
...
function requireDispatchRequest() {
  ...
  dispatchRequest$1 = function dispatchRequest2(config) {
...
function requireMergeConfig() {
  if (hasRequiredMergeConfig) return mergeConfig$1;
  hasRequiredMergeConfig = 1;
  var utils2 = requireUtils$1();
  mergeConfig$1 = function mergeConfig2(config1, config2) {
    config2 = config2 || {};
    var config = {};
...
function requireValidator() {
  ...
  ["object", "boolean", "number", "function", "string", "symbol"].forEach(function(type2, i) {
    validators2[type2] = function validator2(thing) {
  ...
  validators2.transitional = function transitional2(validator2, version2, message) {
    ...
    return function(value, opt, opts) {
      ...
      if (isDeprecated && !deprecatedWarnings2[opt]) {
...
function requireAxios$2() {
  ...
  Axios2.prototype.request = function request(config) {
    ...
    if (transitional2 !== void 0) {
      validator2.assertOptions(transitional2, {
        silentJSONParsing: validators2.transitional(validators2.boolean, "1.0.0"),
        forcedJSONParsing: validators2.transitional(validators2.boolean, "1.0.0"),
        clarifyTimeoutError: validators2.transitional(validators2.boolean, "1.0.0")
      }, false);
    }
...
function requireAxios$1() {
  ...
  function createInstance2(defaultConfig) {
    ...
    utils2.extend(instance, Axios2.prototype, context);
  ...
  axios2.create = function create(instanceConfig) {
    return createInstance2(mergeConfig2(axios2.defaults, instanceConfig));
  };
...
function requireDist$1() {
  ...
  (function(exports) {
    ...
    var t = e(requireAxios()), n = /* @__PURE__ */ requireLib(), i = e(requireCjs());
    function r() {
    ...
    var o, s = { modal: null, listener: null, show: function(e2) {
      var t2 = this;
    ...
    var v2 = function(e2) {
      ...
      return n2.init = function(e3) {
        ...
        window.history.state.version = e3.version, this.setPage(window.history.state, { preserveScroll: true, preserveState: true }).then(function() {
          t2.restoreScrollPositions(), m2(e3);
        });
      }, n2.locationVisit = function(e3, t2) {
        try {
          window.sessionStorage.setItem("inertiaLocationVisit", JSON.stringify({ preserveScroll: t2 })), window.location.href = e3.href, p2(window.location).href === p2(e3).href && window.location.reload();
        } catch (e4) {
          return false;
        }
        ...
        window.sessionStorage.removeItem("inertiaLocationVisit"), e3.url += window.location.hash, e3.rememberedState = null != (t2 = null == (n3 = window.history.state) ? void 0 : n3.rememberedState) ? t2 : {}, e3.scrollRegions = null != (i2 = null == (r2 = window.history.state) ? void 0 : r2.scrollRegions) ? i2 : [], this.setPage(e3, { preserveScroll: s2.preserveScroll, preserveState: true }).then(function() {
          s2.preserveScroll && o2.restoreScrollPositions(), m2(e3);
        });
        ...
        !e3 || e3.completed || e3.cancelled || e3.interrupted || (e3.cancelToken.cancel(), e3.onCancel(), e3.completed = false, e3.cancelled = i2, e3.interrupted = o2, v2(e3), e3.onFinish(e3));
      }, n2.finishVisit = function(e3) {
        e3.cancelled || e3.interrupted || (e3.completed = true, e3.cancelled = false, e3.interrupted = false, v2(e3), e3.onFinish(e3));
        ...
        var i2 = this, o2 = void 0 === n3 ? {} : n3, a2 = o2.method, l2 = void 0 === a2 ? exports.Method.GET : a2, d2 = o2.data, v3 = void 0 === d2 ? {} : d2, m3 = o2.replace, g2 = void 0 !== m3 && m3, w3 = o2.preserveScroll, y2 = void 0 !== w3 && w3, S2 = o2.preserveState, b2 = void 0 !== S2 && S2, E2 = o2.only, P = void 0 === E2 ? [] : E2, T = o2.headers, I2 = void 0 === T ? {} : T, x = o2.errorBag, V = void 0 === x ? "" : x, L = o2.forceFormData, O = void 0 !== L && L, k2 = o2.onCancelToken, C2 = void 0 === k2 ? function() {
        } : k2, M = o2.onBefore, A = void 0 === M ? function() {
        } : M, j = o2.onStart, F = void 0 === j ? function() {
        } : j, R = o2.onProgress, D2 = void 0 === R ? function() {
        } : R, B2 = o2.onFinish, q = void 0 === B2 ? function() {
        } : B2, N = o2.onCancel, H = void 0 === N ? function() {
        } : N, W2 = o2.onSuccess, G = void 0 === W2 ? function() {
        } : W2, U = o2.onError, X = void 0 === U ? function() {
        ...
        }(v3) && !O || v3 instanceof FormData || (v3 = c(v3)), !(v3 instanceof FormData)) {
          var z = h2(l2, _, v3, K), Q = z[1];
          _ = u(z[0]), v3 = Q;
        }
        var Y = { url: _, method: l2, data: v3, replace: g2, preserveScroll: y2, preserveState: b2, only: P, headers: I2, errorBag: V, forceFormData: O, queryStringArrayFormat: K, cancelled: false, completed: false, interrupted: false };
        if (false !== A(Y) && function(e4) {
          ...
          this.activeVisit = r({}, Y, { onCancelToken: C2, onBefore: A, onStart: F, onProgress: D2, onFinish: q, onCancel: H, onSuccess: G, onError: X, queryStringArrayFormat: K, cancelToken: t.CancelToken.source() }), C2({ cancel: function() {
            i2.activeVisit && i2.cancelVisit(i2.activeVisit, { cancelled: true });
          } }), function(e4) {
            f("start", { detail: { visit: e4 } });
          }(Y), F(Y), t({ method: l2, url: p2(_).href, data: l2 === exports.Method.GET ? {} : v3, params: l2 === exports.Method.GET ? v3 : {}, cancelToken: this.activeVisit.cancelToken.token, headers: r({}, I2, { Accept: "text/html, application/xhtml+xml", "X-Requested-With": "XMLHttpRequest", "X-Inertia": true }, P.length ? { "X-Inertia-Partial-Component": this.page.component, "X-Inertia-Partial-Data": P.join(",") } : {}, V && V.length ? { "X-Inertia-Error-Bag": V } : {}, this.page.version ? { "X-Inertia-Version": this.page.version } : {}), onUploadProgress: function(e4) {
            v3 instanceof FormData && (e4.percentage = Math.round(e4.loaded / e4.total * 100), function(e5) {
            ...
            var n4 = e4.data;
            P.length && n4.component === i2.page.component && (n4.props = r({}, i2.page.props, n4.props)), y2 = i2.resolvePreserveOption(y2, n4), (b2 = i2.resolvePreserveOption(b2, n4)) && null != (t2 = window.history.state) && t2.rememberedState && n4.component === i2.page.component && (n4.rememberedState = window.history.state.rememberedState);
            var o3 = _, s2 = u(n4.url);
            return o3.hash && !s2.hash && p2(o3).href === s2.href && (s2.hash = o3.hash, n4.url = s2.href), i2.setPage(n4, { visitId: Z, replace: g2, preserveScroll: y2, preserveState: b2 });
          }).then(function() {
            ...
            if (i2.isLocationVisitResponse(e4.response)) {
              ...
              n4.hash && !t2.hash && p2(n4).href === t2.href && (t2.hash = n4.hash), i2.locationVisit(t2, true === y2);
            } else {
        ...
        var n3 = this, i2 = void 0 === t2 ? {} : t2, r2 = i2.visitId, o2 = void 0 === r2 ? this.createVisitId() : r2, s2 = i2.replace, a2 = void 0 !== s2 && s2, c2 = i2.preserveScroll, l2 = void 0 !== c2 && c2, d2 = i2.preserveState, h3 = void 0 !== d2 && d2;
        return Promise.resolve(this.resolveComponent(e3.component)).then(function(t3) {
          o2 === n3.visitId && (e3.scrollRegions = e3.scrollRegions || [], e3.rememberedState = e3.rememberedState || {}, (a2 = a2 || u(e3.url).href === window.location.href) ? n3.replaceState(e3) : n3.pushState(e3), n3.swapComponent({ component: t3, page: e3, preserveState: h3 }).then(function() {
            l2 || n3.resetScrollPositions(), a2 || m2(e3);
          }));
        });
        ...
        if (null !== e3.state) {
          ...
          Promise.resolve(this.resolveComponent(n3.component)).then(function(e4) {
            i2 === t2.visitId && (t2.page = n3, t2.swapComponent({ component: e4, page: n3, preserveState: false }).then(function() {
              t2.restoreScrollPositions(), m2(n3);
            }));
          });
        } else {
    ...
    }, exports.hrefToUrl = u, exports.mergeDataIntoQueryString = h2, exports.shouldIntercept = function(e2) {
...
function requireDist() {
  ...
  var r = e(requireLodash_isequal()), t = require$$1, n = e(requireLodash_clonedeep()), o = requireDist$1();
  function i() {
  ...
  function a() {
    var e2 = [].slice.call(arguments), a2 = "string" == typeof e2[0] ? e2[0] : null, u2 = ("string" == typeof e2[0] ? e2[1] : e2[0]) || {}, s2 = a2 ? o.Inertia.restore(a2) : null, c2 = n(u2), l2 = null, p3 = null, f2 = function(e3) {
      return e3;
      ...
      var s3 = f2(this.data()), d3 = i({}, t2, { onCancelToken: function(e4) {
        ...
        if (u3.wasSuccessful = false, u3.recentlySuccessful = false, clearTimeout(p3), t2.onBefore) return t2.onBefore(e4);
      }, onStart: function(e4) {
        ...
        try {
          ...
          return a3.processing = false, a3.progress = null, a3.clearErrors(), a3.wasSuccessful = true, a3.recentlySuccessful = true, p3 = setTimeout(function() {
  ...
  var u = { created: function() {
  ...
  } }, s = t.ref(null), c = t.ref({}), l = t.ref(null), p2 = null, f = { name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: function(e2) {
    return e2;
    ...
    return p2 = o.createHeadManager(d2, u2, f2), d2 || o.Inertia.init({ initialPage: r2, resolveComponent: a2, swapComponent: function(e3) {
      try {
  ...
  } }, h2 = { props: { title: { type: String, required: false } }, data: function() {
  ...
  } }, m2 = { name: "InertiaLink", props: { as: { type: String, default: "a" }, data: { type: Object, default: function() {
    return {};
  ...
  dist$1.App = f, dist$1.Head = h2, dist$1.InertiaApp = f, dist$1.InertiaHead = h2, dist$1.InertiaLink = m2, dist$1.Link = m2, dist$1.app = f, dist$1.createInertiaApp = function(e2) {
    try {
      var r2, n2, o2, i2, a2, u2, s2;
      n2 = void 0 === (r2 = e2.id) ? "app" : r2, o2 = e2.resolve, i2 = e2.setup, a2 = e2.title, u2 = e2.page, s2 = e2.render;
      var c2 = "undefined" == typeof window, l2 = c2 ? null : document.getElementById(n2), p3 = u2 || JSON.parse(l2.dataset.page), h3 = function(e3) {
        return Promise.resolve(o2(e3)).then(function(e4) {
          return e4.default || e4;
        });
      }, m3 = [];
      return Promise.resolve(h3(p3.component).then(function(e3) {
        return i2({ el: l2, app: f, App: f, props: { initialPage: p3, initialComponent: e3, resolveComponent: h3, titleCallback: a2, onHeadUpdate: c2 ? function(e4) {
          return m3 = e4;
        } : null }, plugin: d });
      })).then(function(e3) {
        return function() {
          if (c2) return Promise.resolve(s2(t.createSSRApp({ render: function() {
            return t.h("div", { id: n2, "data-page": JSON.stringify(p3), innerHTML: s2(e3) });
          } }))).then(function(e4) {
            return { head: m3, body: e4 };
          });
        }();
      });
    } catch (e3) {
  ...
  }, dist$1.link = m2, dist$1.plugin = d, dist$1.useForm = a, dist$1.usePage = function() {
  ...
  }, dist$1.useRemember = function(e2, r2) {
...
distExports.createInertiaApp({
  title: (title) => `${title}`,
  resolve: (name2) => resolvePageComponent(`./Pages/${name2}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmTwoFactorAuthentication.vue": () => __vitePreload(() => import("./ConfirmTwoFactorAuthentication-CKU9fh3C.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0), "./Pages/Auth/Email.vue": () => __vitePreload(() => import("./Email-DlepH0uC.js"), true ? __vite__mapDeps([6,1,2,3,4,5,7]) : void 0), "./Pages/Auth/Login.vue": () => __vitePreload(() => import("./Login-D91fbxa-.js"), true ? __vite__mapDeps([8,1,2,3,4,5]) : void 0), "./Pages/Auth/PasswordCreation.vue": () => __vitePreload(() => import("./PasswordCreation-Dz6pNQDH.js"), true ? __vite__mapDeps([9,1,2,3,4,5,7]) : void 0), "./Pages/Auth/Register.vue": () => __vitePreload(() => import("./Register-n5IReClC.js"), true ? __vite__mapDeps([10,1,2,3,4,5,7]) : void 0), "./Pages/Auth/Reset.vue": () => __vitePreload(() => import("./Reset-DYp4bqjf.js"), true ? __vite__mapDeps([11,1,2,3,4,5,7]) : void 0), "./Pages/Core/InstallationIncomplete.vue": () => __vitePreload(() => import("./InstallationIncomplete-BUSJaFjn.js"), true ? __vite__mapDeps([12,1,2,3,4,5]) : void 0), "./Pages/Dashboard/Index.vue": () => __vitePreload(() => import("./Index-DshtNbuc.js"), true ? __vite__mapDeps([13,14,15,5,2,16,7,4,17]) : void 0), "./Pages/Dashboard/components/TopBar.vue": () => __vitePreload(() => import("./TopBar-DMfjE_VA.js"), true ? __vite__mapDeps([14,15,5,2]) : void 0), "./Pages/Documentation/Article.vue": () => __vitePreload(() => import("./Article-DR0wEx-0.js"), true ? __vite__mapDeps([18,19,15,5,2,16,7,4,20,17,21,22,3,23,24,25,26]) : void 0), "./Pages/Documentation/Index.vue": () => __vitePreload(() => import("./Index-qisA3RB9.js"), true ? __vite__mapDeps([27,19,15,5,2,16,7,4,20,17,21,22,3,23,24,25,26]) : void 0), "./Pages/Documentation/Show.vue": () => __vitePreload(() => import("./Show-WtH056xq.js"), true ? __vite__mapDeps([28,19,15,5,2,16,7,4,20,17,21,22,3,23,24,25,26]) : void 0), "./Pages/Documentation/Tabs.vue": () => __vitePreload(() => import("./Tabs-CLBkCKLq.js"), true ? __vite__mapDeps([26,2]) : void 0), "./Pages/Documentation/components/TopBar.vue": () => __vitePreload(() => import("./TopBar-jLMaTmmN.js"), true ? __vite__mapDeps([19,15,5,2]) : void 0), "./Pages/Errors/403.vue": () => __vitePreload(() => import("./403-b5BEXk6V.js"), true ? __vite__mapDeps([29,14,15,5,2,16,7,4]) : void 0), "./Pages/Errors/404.vue": () => __vitePreload(() => import("./404-Px2-rR6a.js"), true ? __vite__mapDeps([30,5,2,16,7,4]) : void 0), "./Pages/Pages/Privacy.vue": () => __vitePreload(() => import("./Privacy-CL0NVdVF.js"), true ? __vite__mapDeps([31,1,2,3,4,5]) : void 0), "./Pages/Pages/Terms.vue": () => __vitePreload(() => import("./Terms-96_Pe3rQ.js"), true ? __vite__mapDeps([32,1,2,3,4,5]) : void 0), "./Pages/Profile/Billing.vue": () => __vitePreload(() => import("./Billing-DRxAgK8J.js"), true ? __vite__mapDeps([33,34,15,5,2,16,7,4,17,35,21,22,3,36,23,37,38]) : void 0), "./Pages/Profile/BillingError.vue": () => __vitePreload(() => import("./BillingError-CjTm-3WS.js"), true ? __vite__mapDeps([39,34,15,5,2,16,7,4,17,35,21,22]) : void 0), "./Pages/Profile/Index.vue": () => __vitePreload(() => import("./Index-BfJ4SQA7.js"), true ? __vite__mapDeps([40,34,15,5,2,16,7,4,17,21,22,3,36]) : void 0), "./Pages/Profile/Integrations.vue": () => __vitePreload(() => import("./Integrations-BV7qRvVI.js"), true ? __vite__mapDeps([41,34,15,5,2,16,7,4,17,21,22,3,36,37,38]) : void 0), "./Pages/Profile/Security.vue": () => __vitePreload(() => import("./Security-DV3XDris.js"), true ? __vite__mapDeps([42,34,15,5,2,16,7,4,17,21,22,3,36,24,43]) : void 0), "./Pages/Profile/Settings.vue": () => __vitePreload(() => import("./Settings-C4G6ZX-q.js"), true ? __vite__mapDeps([44,34,15,5,2,16,7,4,17,21,22,3,36,38]) : void 0), "./Pages/Profile/components/TopBar.vue": () => __vitePreload(() => import("./TopBar-CQGSZ3ic.js"), true ? __vite__mapDeps([34,15,5,2]) : void 0), "./Pages/Profile/components/TwoFactorAuthentication.vue": () => __vitePreload(() => import("./TwoFactorAuthentication-BSwESyp9.js"), true ? __vite__mapDeps([43,4,2,3]) : void 0), "./Pages/Servers/Index.vue": () => __vitePreload(() => import("./Index-CGVruxHX.js"), true ? __vite__mapDeps([45,46,15,5,2,16,7,4,17,47,20,21,22,3,36,38]) : void 0), "./Pages/Servers/Settings.vue": () => __vitePreload(() => import("./Settings-COH35X89.js"), true ? __vite__mapDeps([48,46,15,5,2,16,7,4,17,47,20,21,22,3,25,24,49,50,37,38]) : void 0), "./Pages/Servers/Show.vue": () => __vitePreload(() => import("./Show-ojC8DAgT.js"), true ? __vite__mapDeps([51,46,15,5,2,16,7,4,17,47,20,21,22,3,25,24,49,50,37]) : void 0), "./Pages/Servers/Tabs.vue": () => __vitePreload(() => import("./Tabs-m_asZ-07.js"), true ? __vite__mapDeps([50,2]) : void 0), "./Pages/Servers/components/TopBar.vue": () => __vitePreload(() => import("./TopBar-C2EIvggU.js"), true ? __vite__mapDeps([46,15,5,2]) : void 0), "./Pages/Sites/Aliases.vue": () => __vitePreload(() => import("./Aliases-B0FGHMJ5.js"), true ? __vite__mapDeps([52,53,15,5,2,16,7,4,25,24,3,36,23,22,49,20,38,54,37]) : void 0), "./Pages/Sites/Apps.vue": () => __vitePreload(() => import("./Apps-CQjXw7zd.js"), true ? __vite__mapDeps([55,53,15,5,2,16,7,4,25,24,3,22,54,37]) : void 0), "./Pages/Sites/Certificates.vue": () => __vitePreload(() => import("./Certificates-DBhcAUIn.js"), true ? __vite__mapDeps([56,53,15,5,2,16,7,4,25,24,3,36,23,22,49,20,38,54,37]) : void 0), "./Pages/Sites/Cronjobs.vue": () => __vitePreload(() => import("./Cronjobs-Ba52bojt.js"), true ? __vite__mapDeps([57,53,15,5,2,16,7,4,25,24,3,22,49,20,38,54,37]) : void 0), "./Pages/Sites/Databases.vue": () => __vitePreload(() => import("./Databases-DcCxw3D5.js"), true ? __vite__mapDeps([58,53,15,5,2,16,7,4,25,24,3,22,49,20,38,54,37]) : void 0), "./Pages/Sites/Dns.vue": () => __vitePreload(() => import("./Dns-DUBzZKNM.js"), true ? __vite__mapDeps([59,53,15,5,2,16,7,4,25,24,3,22,49,38,54,37,20]) : void 0), "./Pages/Sites/Index.vue": () => __vitePreload(() => import("./Index-D9SSCZ6i.js"), true ? __vite__mapDeps([60,53,15,5,2,16,7,4,20,17,47,21,22,3,36,38,49]) : void 0), "./Pages/Sites/Redirects.vue": () => __vitePreload(() => import("./Redirects-C9LDRZFh.js"), true ? __vite__mapDeps([61,53,15,5,2,16,7,4,25,24,3,36,22,49,20,38,54,37]) : void 0), "./Pages/Sites/Settings.vue": () => __vitePreload(() => import("./Settings-C3tUafTD.js"), true ? __vite__mapDeps([62,53,15,5,2,16,7,4,25,24,3,22,38,54]) : void 0), "./Pages/Sites/Show.vue": () => __vitePreload(() => import("./Show-CmYXhbn3.js"), true ? __vite__mapDeps([63,53,15,5,2,16,7,4,25,24,3,22,54,37,21]) : void 0), "./Pages/Sites/Tabs.vue": () => __vitePreload(() => import("./Tabs-Cw5fne8N.js"), true ? __vite__mapDeps([54,2]) : void 0), "./Pages/Sites/components/TopBar.vue": () => __vitePreload(() => import("./TopBar-BBFAS78u.js"), true ? __vite__mapDeps([53,15,5,2]) : void 0), "./Pages/Support/Closed.vue": () => __vitePreload(() => import("./Closed-Bv8M42tZ.js"), true ? __vite__mapDeps([64,65,15,5,2,16,7,4,17,21,22,3]) : void 0), "./Pages/Support/Index.vue": () => __vitePreload(() => import("./Index-CPMV_3c4.js"), true ? __vite__mapDeps([66,65,15,5,2,16,7,4,17,21,22,3,23,20]) : void 0), "./Pages/Support/Show.vue": () => __vitePreload(() => import("./Show-PBdjqeXa.js"), true ? __vite__mapDeps([67,65,15,5,2,16,7,4,17,21,22,3,23]) : void 0), "./Pages/Support/components/TopBar.vue": () => __vitePreload(() => import("./TopBar-eC08ONVz.js"), true ? __vite__mapDeps([65,15,5,2]) : void 0) })),
  setup({ el, App, props, plugin }) {
    createApp({
      render: () => h(App, props)
    }).use(plugin).use(vClickOutside).use(VueClipboard).use(store).use(D).mixin({ methods: { route: window.route } }).mixin(mixins).component("InertiaLink", distExports.InertiaLink).component("Head", distExports.Head).mount(el);
  },
  progress: {
    delay: 250,
    color: "#1b8ae8",
