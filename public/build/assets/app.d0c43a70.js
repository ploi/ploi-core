...
(function(module, exports) {
  ...
  if (DataView2 && getTag2(new DataView2(new ArrayBuffer(1))) != dataViewTag2 || Map2 && getTag2(new Map2()) != mapTag2 || Promise2 && getTag2(Promise2.resolve()) != promiseTag || Set2 && getTag2(new Set2()) != setTag2 || WeakMap2 && getTag2(new WeakMap2()) != weakMapTag2) {
...
const toDisplayString = (val) => {
  return isString$3(val) ? val : val == null ? "" : isArray$9(val) || isObject$5(val) && (val.toString === objectToString$3 || !isFunction$4(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val);
};
...
function doWatch(source, cb, { immediate, deep, flush, onTrack, onTrigger } = EMPTY_OBJ) {
  ...
  if (cb && !deep) {
    ...
    getter = () => {
      ...
      if (isArray$9(val) && checkCompatEnabled("WATCH_ARRAY", instance)) {
        traverse(val);
      }
      return val;
    };
  ...
  const job = () => {
    ...
    if (cb) {
      ...
      if (deep || forceTrigger || (isMultiSource ? newValue.some((v, i2) => hasChanged(v, oldValue[i2])) : hasChanged(newValue, oldValue)) || isArray$9(newValue) && isCompatEnabled("WATCH_ARRAY", instance)) {
        if (cleanup) {
          cleanup();
        }
        callWithAsyncErrorHandling(cb, instance, 3, [
...
function convertLegacyProps(legacyProps, type) {
  ...
  if (legacyProps.model && isObject$5(type)) {
...
function renderList(source, renderItem, cache, index2) {
  ...
  if (isArray$9(source) || isString$3(source)) {
    ...
    if (publicGetter) {
    ...
    } else if (globalProperties = appContext.config.globalProperties, hasOwn$2(globalProperties, key)) {
      {
        ...
        if (desc.get) {
          ...
          return isFunction$4(val) ? Object.assign(val.bind(instance.proxy), val) : val;
        }
      }
    } else
      ;
...
function mergeDataFn(to, from) {
  ...
  return function mergedDataFn() {
    return (isCompatEnabled("OPTIONS_DATA_MERGE", null) ? deepMergeData : extend$1)(isFunction$4(to) ? to.call(this, this) : to, isFunction$4(from) ? from.call(this, this) : from);
  };
}
...
function createCompatVue(createApp2, createSingletonApp) {
  ...
  Vue2.use = (p2, ...options) => {
    if (p2 && isFunction$4(p2.install)) {
      p2.install(Vue2, ...options);
    } else if (isFunction$4(p2)) {
      p2(Vue2, ...options);
    }
    return Vue2;
  };
  ...
  function extendCtor(extendOptions = {}) {
    ...
    for (const key in Super.options) {
      ...
      mergeBase[key] = isArray$9(superValue) ? superValue.slice() : isObject$5(superValue) ? extend$1(/* @__PURE__ */ Object.create(null), superValue) : superValue;
    }
...
function applySingletonAppMutations(app2) {
  ...
  for (const key in singletonApp.config) {
    ...
    app2.config[key] = isObject$5(val) ? Object.create(val) : val;
    if (key === "ignoredElements" && isCompatEnabled("CONFIG_IGNORED_ELEMENTS", null) && !isRuntimeOnly() && isArray$9(val)) {
      app2.config.compilerOptions.isCustomElement = (tag) => {
        return val.some((v) => isString$3(v) ? v === tag : v.test(tag));
      };
    }
  }
...
const TeleportImpl = {
  ...
  process(n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized, internals) {
    const { mc: mountChildren, pc: patchChildren, pbc: patchBlockChildren, o: { insert, querySelector: querySelector3, createText, createComment } } = internals;
    ...
    if (n1 == null) {
      ...
      const target = n2.target = resolveTarget(n2.props, querySelector3);
      ...
      if (disabled) {
        ...
        if ((n2.props && n2.props.to) !== (n1.props && n1.props.to)) {
          const nextTarget = n2.target = resolveTarget(n2.props, querySelector3);
          if (nextTarget) {
...
function hydrateTeleport(node, vnode, parentComponent, parentSuspense, slotScopeIds, optimized, { o: { nextSibling, parentNode, querySelector: querySelector3 } }, hydrateChildren) {
  const target = vnode.target = resolveTarget(vnode.props, querySelector3);
  if (target) {
...
function convertLegacyComponent(comp, instance) {
  ...
  if (isFunction$4(comp) && checkCompatEnabled("COMPONENT_ASYNC", instance, comp)) {
    return convertLegacyAsyncComponent(comp);
  }
  if (isObject$5(comp) && comp.functional && softAssertCompatEnabled("COMPONENT_FUNCTIONAL", instance, comp)) {
...
function _createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
  ...
  const shapeFlag = isString$3(type) ? 1 : isSuspense(type) ? 128 : isTeleport(type) ? 64 : isObject$5(type) ? 4 : isFunction$4(type) ? 2 : 0;
...
function mergeDefaults(raw, defaults2) {
  const props = isArray$9(raw) ? raw.reduce((normalized, p2) => (normalized[p2] = {}, normalized), {}) : raw;
...
class VueElement extends BaseClass {
  ...
  _resolveDef() {
    ...
    const resolve2 = (def2) => {
      ...
      const hasOptions = !isArray$9(props);
...
function setSelected(el, value) {
  ...
  if (isMultiple && !isArray$9(value) && !isSet$1(value)) {
    return;
  }
...
var stringify$1 = function stringify(object, prefix, generateArrayPrefix, commaRoundTrip, strictNullHandling, skipNulls, encoder, filter, sort, allowDots, serializeDate2, format, formatter, encodeValuesOnly, charset, sideChannel2) {
  ...
  for (var j = 0; j < objKeys.length; ++j) {
    ...
    var keyPrefix = isArray$5(obj) ? typeof generateArrayPrefix === "function" ? generateArrayPrefix(adjustedPrefix, key) : adjustedPrefix : adjustedPrefix + (allowDots ? "." + key : "[" + key + "]");
...
(function(exports) {
  ...
  var v = function(e3) {
  ...
  }, g = "undefined" == typeof window, w = function() {
    function e3() {
      this.visitId = null;
    }
    var n3 = e3.prototype;
    return n3.init = function(e4) {
      ...
      var i3 = this, o3 = void 0 === n4 ? {} : n4, a3 = o3.method, l3 = void 0 === a3 ? exports.Method.GET : a3, d3 = o3.data, v2 = void 0 === d3 ? {} : d3, m3 = o3.replace, g2 = void 0 !== m3 && m3, w2 = o3.preserveScroll, y2 = void 0 !== w2 && w2, S2 = o3.preserveState, b = void 0 !== S2 && S2, E = o3.only, P = void 0 === E ? [] : E, I = o3.headers, x = void 0 === I ? {} : I, V = o3.errorBag, T = void 0 === V ? "" : V, L = o3.forceFormData, O = void 0 !== L && L, k = o3.onCancelToken, C = void 0 === k ? function() {
      } : k, M = o3.onBefore, A = void 0 === M ? function() {
      } : M, F = o3.onStart, R = void 0 === F ? function() {
      ...
      var Y = { url: _, method: l3, data: v2, replace: g2, preserveScroll: y2, preserveState: b, only: P, headers: x, errorBag: T, forceFormData: O, queryStringArrayFormat: K, cancelled: false, completed: false, interrupted: false };
      if (false !== A(Y) && function(e5) {
        ...
        this.activeVisit = r2({}, Y, { onCancelToken: C, onBefore: A, onStart: R, onProgress: D, onFinish: q, onCancel: H, onSuccess: G, onError: X, queryStringArrayFormat: K, cancelToken: t2.CancelToken.source() }), C({ cancel: function() {
          ...
          var n5 = e5.data;
          P.length && n5.component === i3.page.component && (n5.props = r2({}, i3.page.props, n5.props)), y2 = i3.resolvePreserveOption(y2, n5), (b = i3.resolvePreserveOption(b, n5)) && null != (t3 = window.history.state) && t3.rememberedState && n5.component === i3.page.component && (n5.rememberedState = window.history.state.rememberedState);
          var o4 = _, s3 = u2(n5.url);
          return o4.hash && !s3.hash && p2(o4).href === s3.href && (s3.hash = o4.hash, n5.url = s3.href), i3.setPage(n5, { visitId: Z, replace: g2, preserveScroll: y2, preserveState: b });
        }).then(function() {
...
} }, s$1 = t$1.ref(null), c = t$1.ref({}), l = t$1.ref(null), p = null, f = { name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: function(e2) {
  return e2;
...
} }, m = { name: "InertiaLink", props: { as: { type: String, default: "a" }, data: { type: Object, default: function() {
  return {};
...
InertiaLink = m, createInertiaApp = function(e2) {
  try {
...
function find$1(array, predicate, thisArg) {
...
function hasMetaInfo(vm) {
  vm = vm || this;
  return vm && (vm[rootConfigKey] === true || isObject$3(vm[rootConfigKey]));
}
      ...
      if (!$root[rootConfigKey]) {
        ...
        if (devtoolsEnabled && $root.$options[options.keyName]) {
          this.$nextTick(function() {
            var child = find$1($root.$children, function(c2) {
              return c2.$vnode && c2.$vnode.fnOptions;
            });
...
function setOptions(options) {
  options = isObject$3(options) ? options : {};
  return {
...
function ensureIsArray(arg, key) {
  if (!key || !isObject$3(arg)) {
    return isArray$3(arg) ? arg : [];
  }
...
function escape$1(info, options, escapeOptions, escapeKeys) {
  ...
  for (var key in info) {
    ...
    if (isString(value)) {
      ...
      escaped[key] = value.map(function(v) {
        if (isPureObject(v)) {
          return escape$1(v, options, escapeOptions, true);
        }
        return doEscape(v);
      });
    } else if (isPureObject(value)) {
      escaped[key] = escape$1(value, options, escapeOptions, true);
    } else {
      escaped[key] = value;
    }
    if (escapeKeys) {
...
function escapeMetaInfo(options, info, escapeSequences) {
  ...
  return escape$1(info, options, escapeOptions);
}
function applyTemplate(_ref, headObject, template, chunk) {
  ...
  headObject[contentKeyName2] = isFunction$2(template) ? template.call(component, chunk) : template.replace(/%s/g, chunk);
  return true;
}
...
function merge2(target, source, options) {
  ...
  return cjs(target, source, {
    arrayMerge: function arrayMerge(t2, s2) {
      return _arrayMerge(options, t2, s2);
    }
  });
}
...
function getComponentOption(options, component, result) {
  ...
  if ($options[keyName2]) {
    ...
    if (isObject$3(data)) {
      result = merge2(result, data, options);
    }
  }
  if ($children.length) {
...
var callbacks = [];
function isDOMComplete(d2) {
  return (d2 || document).readyState === "complete";
}
...
function generateServerInjector(options, metaInfo, globalInjectOptions) {
  var serverInjector = {
    ...
    callInjectors: function callInjectors(opts) {
      var m2 = this.injectors;
      return (opts.body || opts.pbody ? "" : m2.title.text(opts)) + m2.meta.text(opts) + m2.base.text(opts) + m2.link.text(opts) + m2.style.text(opts) + m2.script.text(opts) + m2.noscript.text(opts);
    },
    injectors: {
...
function $meta(options) {
  ...
  return {
    ...
    inject: function inject$12(injectOptions) {
...
const actions = {
  notify({ commit: commit2 }, payload) {
    ...
    setTimeout(() => commit2(CLOSE_NOTIFICATION), (_a = payload.timeout) != null ? _a : 4e3);
  }
};
const notification = {
  namespaced: true,
...
(function(module, exports) {
  !function(e2, n2) {
    ...
    var e2 = "__v-click-outside", n2 = "undefined" != typeof window, t2 = "undefined" != typeof navigator, r2 = n2 && ("ontouchstart" in window || t2 && navigator.msMaxTouchPoints > 0) ? ["touchstart"] : ["click"];
    function i2(e3) {
    ...
    function a2(n3, t3) {
      var a3 = function(e3) {
        ...
        return { handler: n4 ? e3 : e3.handler, middleware: e3.middleware || function(e4) {
          return e4;
        }, events: e3.events || r2, isActive: !(false === e3.isActive), detectIframe: !(false === e3.detectIframe), capture: !!e3.capture };
      }(t3.value), d3 = a3.handler, o3 = a3.middleware, c2 = a3.detectIframe, u2 = a3.capture;
      if (a3.isActive) {
        if (n3[e2] = a3.events.map(function(e3) {
          return { event: e3, srcTarget: document.documentElement, handler: function(e4) {
            return function(e5) {
              var n4 = e5.el, t4 = e5.event, r3 = e5.handler, a4 = e5.middleware, d4 = t4.composedPath && t4.composedPath() || t4.path;
              (d4 ? d4.indexOf(n4) < 0 : !n4.contains(t4.target)) && i2({ event: t4, handler: r3, middleware: a4 });
            }({ el: n3, event: e4, handler: d3, middleware: o3 });
          }, capture: u2 };
        }), c2) {
          var l2 = { event: "blur", srcTarget: window, handler: function(e3) {
            ...
            }({ el: n3, event: e3, handler: d3, middleware: o3 });
          }, capture: u2 };
    ...
    var o2 = n2 ? { bind: a2, update: function(e3, n3) {
      var t3 = n3.value, r3 = n3.oldValue;
      JSON.stringify(t3) !== JSON.stringify(r3) && (d2(e3), a2(e3, { value: t3 }));
    }, unbind: d2 } : {};
    return { install: function(e3) {
      e3.directive("click-outside", o2);
    }, directive: o2 };
  });
})(vClickOutside_umd);
...
createInertiaApp({
  ...
  resolve: (name2) => resolvePageComponent(`./Pages/${name2}.vue`, Object.assign({ "./Pages/Auth/ConfirmTwoFactorAuthentication.vue": () => __vitePreload(() => import("./ConfirmTwoFactorAuthentication.a42477b3.js"), true ? ["assets/ConfirmTwoFactorAuthentication.a42477b3.js","assets/TextDivider.5d9b42bc.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/FormInput.8ab0f203.js","assets/Button.f40f5f07.js","assets/Container.23db6f9d.js"] : void 0), "./Pages/Auth/Email.vue": () => __vitePreload(() => import("./Email.08f86537.js"), true ? ["assets/Email.08f86537.js","assets/TextDivider.5d9b42bc.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/FormInput.8ab0f203.js","assets/Button.f40f5f07.js","assets/Container.23db6f9d.js","assets/notification.4c298cac.js"] : void 0), "./Pages/Auth/Login.vue": () => __vitePreload(() => import("./Login.7fb2450a.js"), true ? ["assets/Login.7fb2450a.js","assets/TextDivider.5d9b42bc.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/FormInput.8ab0f203.js","assets/Button.f40f5f07.js","assets/Container.23db6f9d.js"] : void 0), "./Pages/Auth/PasswordCreation.vue": () => __vitePreload(() => import("./PasswordCreation.f906d579.js"), true ? ["assets/PasswordCreation.f906d579.js","assets/TextDivider.5d9b42bc.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/FormInput.8ab0f203.js","assets/Button.f40f5f07.js","assets/Container.23db6f9d.js","assets/notification.4c298cac.js"] : void 0), "./Pages/Auth/Register.vue": () => __vitePreload(() => import("./Register.b4ab5764.js"), true ? ["assets/Register.b4ab5764.js","assets/TextDivider.5d9b42bc.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/FormInput.8ab0f203.js","assets/Button.f40f5f07.js","assets/Container.23db6f9d.js","assets/notification.4c298cac.js"] : void 0), "./Pages/Auth/Reset.vue": () => __vitePreload(() => import("./Reset.7480ada0.js"), true ? ["assets/Reset.7480ada0.js","assets/TextDivider.5d9b42bc.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/FormInput.8ab0f203.js","assets/Button.f40f5f07.js","assets/Container.23db6f9d.js","assets/notification.4c298cac.js"] : void 0), "./Pages/Core/InstallationIncomplete.vue": () => __vitePreload(() => import("./InstallationIncomplete.a803ac8b.js"), true ? ["assets/InstallationIncomplete.a803ac8b.js","assets/TextDivider.5d9b42bc.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/FormInput.8ab0f203.js","assets/Button.f40f5f07.js","assets/Container.23db6f9d.js"] : void 0), "./Pages/Dashboard/Index.vue": () => __vitePreload(() => import("./Index.b2298b2e.js"), true ? ["assets/Index.b2298b2e.js","assets/TopBar.ab933635.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js"] : void 0), "./Pages/Dashboard/components/TopBar.vue": () => __vitePreload(() => import("./TopBar.ab933635.js"), true ? ["assets/TopBar.ab933635.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js"] : void 0), "./Pages/Documentation/Article.vue": () => __vitePreload(() => import("./Article.449fe949.js"), true ? ["assets/Article.449fe949.js","assets/TopBar.cc8ad583.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/EmptyImage.626bec44.js","assets/IconStorage.3e58486a.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/FormTextarea.deefc03c.js","assets/SettingsSegment.8dedf9a4.js","assets/SettingsLayout.76203a2a.js","assets/Tabs.f7955794.js"] : void 0), "./Pages/Documentation/Index.vue": () => __vitePreload(() => import("./Index.0cf7e40f.js"), true ? ["assets/Index.0cf7e40f.js","assets/TopBar.cc8ad583.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/EmptyImage.626bec44.js","assets/IconStorage.3e58486a.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/FormTextarea.deefc03c.js","assets/SettingsSegment.8dedf9a4.js","assets/SettingsLayout.76203a2a.js","assets/Tabs.f7955794.js"] : void 0), "./Pages/Documentation/Show.vue": () => __vitePreload(() => import("./Show.6ffef60f.js"), true ? ["assets/Show.6ffef60f.js","assets/TopBar.cc8ad583.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/EmptyImage.626bec44.js","assets/IconStorage.3e58486a.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/FormTextarea.deefc03c.js","assets/SettingsSegment.8dedf9a4.js","assets/SettingsLayout.76203a2a.js","assets/Tabs.f7955794.js"] : void 0), "./Pages/Documentation/Tabs.vue": () => __vitePreload(() => import("./Tabs.f7955794.js"), true ? ["assets/Tabs.f7955794.js","assets/_plugin-vue_export-helper.cdc0426e.js"] : void 0), "./Pages/Documentation/components/TopBar.vue": () => __vitePreload(() => import("./TopBar.cc8ad583.js"), true ? ["assets/TopBar.cc8ad583.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js"] : void 0), "./Pages/Errors/403.vue": () => __vitePreload(() => import("./403.46af2544.js"), true ? ["assets/403.46af2544.js","assets/TopBar.ab933635.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js"] : void 0), "./Pages/Errors/404.vue": () => __vitePreload(() => import("./404.4c463f63.js"), true ? ["assets/404.4c463f63.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js"] : void 0), "./Pages/Pages/Privacy.vue": () => __vitePreload(() => import("./Privacy.d8dffdd5.js"), true ? ["assets/Privacy.d8dffdd5.js","assets/TextDivider.5d9b42bc.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/FormInput.8ab0f203.js","assets/Button.f40f5f07.js","assets/Container.23db6f9d.js"] : void 0), "./Pages/Pages/Terms.vue": () => __vitePreload(() => import("./Terms.938656db.js"), true ? ["assets/Terms.938656db.js","assets/TextDivider.5d9b42bc.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/FormInput.8ab0f203.js","assets/Button.f40f5f07.js","assets/Container.23db6f9d.js"] : void 0), "./Pages/Profile/Billing.vue": () => __vitePreload(() => import("./Billing.12cb1bf8.js"), true ? ["assets/Billing.12cb1bf8.js","assets/TopBar.1920e57d.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js","assets/IconArrowDown.9b5fd04b.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/FormSelect.08a72bf9.js","assets/FormTextarea.deefc03c.js","assets/TableData.b232d5e4.js","assets/confirm.c1a36d4c.js"] : void 0), "./Pages/Profile/BillingError.vue": () => __vitePreload(() => import("./BillingError.8c620683.js"), true ? ["assets/BillingError.8c620683.js","assets/TopBar.1920e57d.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js","assets/IconArrowDown.9b5fd04b.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js"] : void 0), "./Pages/Profile/Index.vue": () => __vitePreload(() => import("./Index.74d55b9c.js"), true ? ["assets/Index.74d55b9c.js","assets/TopBar.1920e57d.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/FormSelect.08a72bf9.js"] : void 0), "./Pages/Profile/Integrations.vue": () => __vitePreload(() => import("./Integrations.e696a0f9.js"), true ? ["assets/Integrations.e696a0f9.js","assets/TopBar.1920e57d.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/FormSelect.08a72bf9.js","assets/TableData.b232d5e4.js","assets/confirm.c1a36d4c.js"] : void 0), "./Pages/Profile/Security.vue": () => __vitePreload(() => import("./Security.1e33d4af.js"), true ? ["assets/Security.1e33d4af.js","assets/TopBar.1920e57d.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/FormSelect.08a72bf9.js","assets/SettingsSegment.8dedf9a4.js","assets/TwoFactorAuthentication.1b305e17.js"] : void 0), "./Pages/Profile/Settings.vue": () => __vitePreload(() => import("./Settings.3e020c27.js"), true ? ["assets/Settings.3e020c27.js","assets/TopBar.1920e57d.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/FormSelect.08a72bf9.js","assets/confirm.c1a36d4c.js"] : void 0), "./Pages/Profile/components/TopBar.vue": () => __vitePreload(() => import("./TopBar.1920e57d.js"), true ? ["assets/TopBar.1920e57d.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js"] : void 0), "./Pages/Profile/components/TwoFactorAuthentication.vue": () => __vitePreload(() => import("./TwoFactorAuthentication.1b305e17.js"), true ? ["assets/TwoFactorAuthentication.1b305e17.js","assets/Button.f40f5f07.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/FormInput.8ab0f203.js"] : void 0), "./Pages/Servers/Index.vue": () => __vitePreload(() => import("./Index.42665b14.js"), true ? ["assets/Index.42665b14.js","assets/TopBar.c224fedc.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js","assets/DropdownListItemButton.b3b80236.js","assets/EmptyImage.626bec44.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/FormSelect.08a72bf9.js","assets/confirm.c1a36d4c.js"] : void 0), "./Pages/Servers/Settings.vue": () => __vitePreload(() => import("./Settings.aa9f0520.js"), true ? ["assets/Settings.aa9f0520.js","assets/TopBar.c224fedc.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js","assets/DropdownListItemButton.b3b80236.js","assets/EmptyImage.626bec44.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/SettingsLayout.76203a2a.js","assets/SettingsSegment.8dedf9a4.js","assets/Pagination.99c0720a.js","assets/Tabs.0a821da5.js","assets/TableData.b232d5e4.js","assets/confirm.c1a36d4c.js"] : void 0), "./Pages/Servers/Show.vue": () => __vitePreload(() => import("./Show.9e361ce9.js"), true ? ["assets/Show.9e361ce9.js","assets/TopBar.c224fedc.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js","assets/DropdownListItemButton.b3b80236.js","assets/EmptyImage.626bec44.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/SettingsLayout.76203a2a.js","assets/SettingsSegment.8dedf9a4.js","assets/Pagination.99c0720a.js","assets/Tabs.0a821da5.js","assets/TableData.b232d5e4.js"] : void 0), "./Pages/Servers/Tabs.vue": () => __vitePreload(() => import("./Tabs.0a821da5.js"), true ? ["assets/Tabs.0a821da5.js","assets/_plugin-vue_export-helper.cdc0426e.js"] : void 0), "./Pages/Servers/components/TopBar.vue": () => __vitePreload(() => import("./TopBar.c224fedc.js"), true ? ["assets/TopBar.c224fedc.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js"] : void 0), "./Pages/Sites/Aliases.vue": () => __vitePreload(() => import("./Aliases.b6ffff64.js"), true ? ["assets/Aliases.b6ffff64.js","assets/TopBar.27e62198.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/SettingsLayout.76203a2a.js","assets/SettingsSegment.8dedf9a4.js","assets/FormInput.8ab0f203.js","assets/FormSelect.08a72bf9.js","assets/FormTextarea.deefc03c.js","assets/Form.097b2c0b.js","assets/Pagination.99c0720a.js","assets/EmptyImage.626bec44.js","assets/confirm.c1a36d4c.js","assets/Tabs.992be93e.js","assets/TableData.b232d5e4.js"] : void 0), "./Pages/Sites/Apps.vue": () => __vitePreload(() => import("./Apps.03be88c4.js"), true ? ["assets/Apps.03be88c4.js","assets/TopBar.27e62198.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/SettingsLayout.76203a2a.js","assets/SettingsSegment.8dedf9a4.js","assets/FormInput.8ab0f203.js","assets/Form.097b2c0b.js","assets/Tabs.992be93e.js","assets/TableData.b232d5e4.js"] : void 0), "./Pages/Sites/Certificates.vue": () => __vitePreload(() => import("./Certificates.cddd25bd.js"), true ? ["assets/Certificates.cddd25bd.js","assets/TopBar.27e62198.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/SettingsLayout.76203a2a.js","assets/SettingsSegment.8dedf9a4.js","assets/FormInput.8ab0f203.js","assets/FormSelect.08a72bf9.js","assets/FormTextarea.deefc03c.js","assets/Form.097b2c0b.js","assets/Pagination.99c0720a.js","assets/EmptyImage.626bec44.js","assets/confirm.c1a36d4c.js","assets/Tabs.992be93e.js","assets/TableData.b232d5e4.js"] : void 0), "./Pages/Sites/Cronjobs.vue": () => __vitePreload(() => import("./Cronjobs.d54d4304.js"), true ? ["assets/Cronjobs.d54d4304.js","assets/TopBar.27e62198.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/SettingsLayout.76203a2a.js","assets/SettingsSegment.8dedf9a4.js","assets/FormInput.8ab0f203.js","assets/Form.097b2c0b.js","assets/Pagination.99c0720a.js","assets/EmptyImage.626bec44.js","assets/confirm.c1a36d4c.js","assets/Tabs.992be93e.js","assets/TableData.b232d5e4.js"] : void 0), "./Pages/Sites/Databases.vue": () => __vitePreload(() => import("./Databases.3422ec5d.js"), true ? ["assets/Databases.3422ec5d.js","assets/TopBar.27e62198.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/SettingsLayout.76203a2a.js","assets/SettingsSegment.8dedf9a4.js","assets/FormInput.8ab0f203.js","assets/Form.097b2c0b.js","assets/Pagination.99c0720a.js","assets/EmptyImage.626bec44.js","assets/confirm.c1a36d4c.js","assets/Tabs.992be93e.js","assets/TableData.b232d5e4.js"] : void 0), "./Pages/Sites/Dns.vue": () => __vitePreload(() => import("./Dns.f532d803.js"), true ? ["assets/Dns.f532d803.js","assets/TopBar.27e62198.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/SettingsLayout.76203a2a.js","assets/SettingsSegment.8dedf9a4.js","assets/FormInput.8ab0f203.js","assets/Form.097b2c0b.js","assets/Pagination.99c0720a.js","assets/confirm.c1a36d4c.js","assets/Tabs.992be93e.js","assets/TableData.b232d5e4.js","assets/EmptyImage.626bec44.js"] : void 0), "./Pages/Sites/Index.vue": () => __vitePreload(() => import("./Index.72aae7d1.js"), true ? ["assets/Index.72aae7d1.js","assets/TopBar.27e62198.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/EmptyImage.626bec44.js","assets/IconStorage.3e58486a.js","assets/DropdownListItemButton.b3b80236.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/FormSelect.08a72bf9.js","assets/confirm.c1a36d4c.js","assets/Pagination.99c0720a.js"] : void 0), "./Pages/Sites/Redirects.vue": () => __vitePreload(() => import("./Redirects.de65db9f.js"), true ? ["assets/Redirects.de65db9f.js","assets/TopBar.27e62198.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/SettingsLayout.76203a2a.js","assets/SettingsSegment.8dedf9a4.js","assets/FormInput.8ab0f203.js","assets/FormSelect.08a72bf9.js","assets/Form.097b2c0b.js","assets/Pagination.99c0720a.js","assets/EmptyImage.626bec44.js","assets/confirm.c1a36d4c.js","assets/Tabs.992be93e.js","assets/TableData.b232d5e4.js"] : void 0), "./Pages/Sites/Settings.vue": () => __vitePreload(() => import("./Settings.70fb14f3.js"), true ? ["assets/Settings.70fb14f3.js","assets/TopBar.27e62198.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/SettingsLayout.76203a2a.js","assets/SettingsSegment.8dedf9a4.js","assets/FormInput.8ab0f203.js","assets/Form.097b2c0b.js","assets/confirm.c1a36d4c.js","assets/Tabs.992be93e.js"] : void 0), "./Pages/Sites/Show.vue": () => __vitePreload(() => import("./Show.ffe672a1.js"), true ? ["assets/Show.ffe672a1.js","assets/TopBar.27e62198.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/SettingsLayout.76203a2a.js","assets/SettingsSegment.8dedf9a4.js","assets/FormInput.8ab0f203.js","assets/Form.097b2c0b.js","assets/Tabs.992be93e.js","assets/TableData.b232d5e4.js","assets/ModalContainer.34fa6055.js"] : void 0), "./Pages/Sites/Tabs.vue": () => __vitePreload(() => import("./Tabs.992be93e.js"), true ? ["assets/Tabs.992be93e.js","assets/_plugin-vue_export-helper.cdc0426e.js"] : void 0), "./Pages/Sites/components/TopBar.vue": () => __vitePreload(() => import("./TopBar.27e62198.js"), true ? ["assets/TopBar.27e62198.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js"] : void 0), "./Pages/Support/Closed.vue": () => __vitePreload(() => import("./Closed.d8fe68d2.js"), true ? ["assets/Closed.d8fe68d2.js","assets/TopBar.a535e262.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js"] : void 0), "./Pages/Support/Index.vue": () => __vitePreload(() => import("./Index.d2887586.js"), true ? ["assets/Index.d2887586.js","assets/TopBar.a535e262.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/FormTextarea.deefc03c.js","assets/EmptyImage.626bec44.js"] : void 0), "./Pages/Support/Show.vue": () => __vitePreload(() => import("./Show.237cbd65.js"), true ? ["assets/Show.237cbd65.js","assets/TopBar.a535e262.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js","assets/MainLayout.46aebdcf.js","assets/notification.4c298cac.js","assets/Button.f40f5f07.js","assets/IconStorage.3e58486a.js","assets/ModalContainer.34fa6055.js","assets/Form.097b2c0b.js","assets/FormInput.8ab0f203.js","assets/FormTextarea.deefc03c.js"] : void 0), "./Pages/Support/components/TopBar.vue": () => __vitePreload(() => import("./TopBar.a535e262.js"), true ? ["assets/TopBar.a535e262.js","assets/TabBar.2102e192.js","assets/Container.23db6f9d.js","assets/_plugin-vue_export-helper.cdc0426e.js"] : void 0) })),
  setup({ el, app: app2, props, plugin }) {
    return createApp({ render: () => h(app2, props) }).use(plugin).use(vClickOutside).use(index$1).use(VueClipboard).use(store).mixin({ methods: { route: window.route } }).mixin(mixins).component("InertiaLink", InertiaLink).mount(el);
  }
});
