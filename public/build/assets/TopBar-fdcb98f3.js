<<<<<<<< HEAD:public/build/assets/TopBar.ddabe973.js
import { T as TopBar$1, B as Breadcrumbs, a as TabBar, b as TopBarTabBarContainer } from "./TabBar.8304c776.js";
import { g as createBlock, w as withCtx, r as resolveComponent, o as openBlock, a as createVNode } from "./app.67ed15d7.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper.cdc0426e.js";
import "./Container.44bb93ee.js";
========
...
>>>>>>>> develop:public/build/assets/TopBar-fdcb98f3.js
const _sfc_main = {
  components: {
    TopBar: TopBar$1,
    Breadcrumbs,
  ...
  computed: {
    hasServerAccess() {
      return this.$page.props.auth.can.length && (this.$page.props.auth.can.servers.create || this.$page.props.auth.can.servers.delete || this.$page.props.auth.can.servers.update);
    }
  },
  data() {
    return {
