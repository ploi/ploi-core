<<<<<<< HEAD
(window.webpackJsonp=window.webpackJsonp||[]).push([[65],{144:function(t,e,a){"use strict";a.r(e);var n=a(68),o=a(1),r=a(6),s=a(7),i=a(8),u=a(9),d=a(10),l=a(2),c=a(11),_=a(12),g=a(4),p=a(5),b={layout:a(3).a,components:{TopBar:n.default,Container:o.a,Content:r.a,Page:s.a,PageHeader:i.a,PageHeaderTitle:u.a,PageBody:d.a,Button:l.a,List:c.a,ListItem:_.a,StatusBubble:g.a,NotificationBadge:p.a},data:function(){return{breadcrumbs:[{title:this.$page.settings.name,to:"/"},{title:"403 not found",to:"/"}]}}},f=a(0),m=Object(f.a)(b,(function(){var t=this,e=t.$createElement,a=t._self._c||e;return a("Page",[a("TopBar",{attrs:{breadcrumbs:t.breadcrumbs}}),t._v(" "),a("Content",[a("Container",[a("PageHeader",{scopedSlots:t._u([{key:"start",fn:function(){return[a("PageHeaderTitle",[t._v(t._s(t.__("Not allowed")))])]},proxy:!0}])}),t._v(" "),a("PageBody",[t._v("\n                "+t._s(t.__("You tried to do something that is not allowed."))+"\n            ")])],1)],1)],1)}),[],!1,null,null,null);e.default=m.exports}}]);
=======
