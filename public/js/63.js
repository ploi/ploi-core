<<<<<<< HEAD
(window.webpackJsonp=window.webpackJsonp||[]).push([[63],[,function(s,e,t){"use strict";var a={small:"max-w-sm",base:"max-w-5xl",large:"max-w-screen-xl"},n={props:{size:{type:String,default:function(){return"base"},validator:function(s){return Object.keys(a).includes(s)}}},data:function(){return{baseClasses:"w-full px-4 sm:px-8 mx-auto",sizeClasses:a}}},l=t(0),i=Object(l.a)(n,(function(){var s=this.$createElement;return(this._self._c||s)("div",{class:[this.baseClasses,this.sizeClasses[this.size]]},[this._t("default")],2)}),[],!1,null,null,null);e.a=i.exports}]]);
=======
